<?php
	...
	if(isset($_REQUEST['add']))
	{
		...
		$query="UPDATE `tbl_area` SET `areaname` = '$areaname', `pincode` = '$pincode' WHERE `tbl_area`.`areaid` = $id";
						...
						<div class="panel-heading">
							<h3 class="panel-title">Add Area</h3>
                                ...
                                <div class=" form p-20" method="post">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="#"  name="f1">                                       
			                            <div class="form-group ">
                                            <label for="Title" class="control-label col-lg-2">Area Name</label>
                                            <div class="col-lg-5">
                                                <input class="form-control " id="title" value="<?= $row['areaname'] ?>" type="text" name="areaname">
											</div>
										</div>
                                        <div class="form-group ">
                                            <label for="reason" class="control-label col-lg-2">Pincode</label>
                                            <div class="col-lg-5">
                                                <input class="form-control" value="<?= $row['pincode'] ?>" id="reason" type="text" name="pincode">
											</div>
										</div>
												</br>
												<div class="form-group">

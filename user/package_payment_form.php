<?php
	...
	setcookie('pid', $_GET['pid'], time() + (86400 * 30), "/"); 
	...
	if(!empty($_POST)) {
        ...
        <tr>
		<td>Email: </td>
		<td><input name="email" id="email" type="hidden" value="<?= $rowuser['email'] ?>" /></td>
		<td>Phone: </td>
		<td><input name="phone" value="<?= $rowuser['mobileno'] ?>" type="hidden" /></td>
        </tr>
        <tr>
		<td>Product Info: </td>
		<td colspan="3"><textarea name="productinfo">Package Payment</textarea></td>
        </tr>
        <tr>
		<td>Success URI: </td>
		<td colspan="3"><input type="hidden"  name="surl" value="http://localhost:8080/sd/user/packagesuccess.php" size="64" /></td>
        </tr>
        <tr>
		<td>Failure URI: </td>
		<td colspan="3"><input type="hidden"  name="furl" value="http://localhost:8080/sd/user/packagefail.php#" size="64" /></td>
        </tr>
